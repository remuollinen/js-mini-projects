...
const API = new FetchWrapper("https://v6.exchangerate-api.com/"); //replace YOUR_API_KEY with the api
// const my_API_KEY = "6d390f7501f39caf2beb6e4c";
...
function getConversionRates() {
	...
	rates.map((rate) => {
		// rate[0] is the currency name (i.e. USD) and rate[1] is the corresponding value, which is the conversion rate

		if (rate[0] === target.value) {
			result.textContent = rate[1];
		}
	});
}
